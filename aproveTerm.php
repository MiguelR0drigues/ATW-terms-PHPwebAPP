...
$updateQuery = "UPDATE termos SET revisto=1,revDate=current_timestamp() WHERE id=?";
...
$txt="<".$name. " @ " . $date."> Updated the term with the id ".$_GET['id']." -- Change: NOT REVISED -> REVISED";
